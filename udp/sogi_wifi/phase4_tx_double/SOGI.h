...
public:
    ...
    double IRAM_ATTR getRotationRate() const { return w_rot; }
    double IRAM_ATTR getFllError(double input) const;
...
public:
     ...
     */
    void IRAM_ATTR update(double fll_err, double rot_err, double ts);

    inline void IRAM_ATTR setDistortionDamping(float p_scale, float learn_scale);
