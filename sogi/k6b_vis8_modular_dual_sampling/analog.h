...
#include <Arduino.h>
#include "driver/adc.h"   // For adc_atten_t enum
...
/**
 * @brief Calibrated analog read returning millivolts.
 *
 * Uses the Arduino-native analogReadMilliVolts() to ensure compatibility
 * with modern ESP32 ADC drivers (driver_ng).
 */
